...
export class VslsContactProvider implements ContactServiceProvider {
    ...
    private readonly _onNotified = new EventEmitter<NotifyContactServiceEventArgs>();
    ...
    public async requestAsync(
        ...
        switch (type) {
            ...
            case Methods.RequestContactPresenceName:
                ...
                result = await this.presenceRequestHandler(<ContactPresenceRequest>parameters);
                break;
    ...
    private async presenceRequestHandler(params: ContactPresenceRequest): Promise<ContactPresenceResponse> {
