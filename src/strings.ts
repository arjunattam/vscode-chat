...
export const TOKEN_NOT_FOUND = "Setup Slack Chat to work for your account."; // TODO: rephrase
export const SIGN_IN_SLACK = "Sign in with Slack";
export const SIGN_IN_DISCORD = "Sign in with Discord";
export const DONT_HAVE_SLACK = "Don't have Slack"; // TODO: rephrase
